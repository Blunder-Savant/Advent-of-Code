...
lcm_monkeys_test = math.lcm(*list(monkey.test for monkey in monkeys))
...
for round in range(10000):
    for monkey in monkeys:
        for item in monkey.items:
            ...
            # Reduce item worry level by least common multiple of each monkey's test
            worry_level %= lcm_monkeys_test
